...
export const Route = createFileRoute("/events")({
  head: () => ({
    meta: seo({
      title: "Events",
      description:
        "Upcoming and past community events: hackathons, workshops, competitions, seminars.",
    }),
  }),
  component: Events,
});
      ...
      {selectedEvent && (
        <div className="modal-overlay" onClick={() => setSelectedEvent(null)}>
          <div className="modal" onClick={(e) => e.stopPropagation()}>
            <button className="modal__close" onClick={() => setSelectedEvent(null)}>
              ✕
            </button>
            <div className="modal__content">
              ...
              <h2 className="display h2" style={{ marginTop: 16, marginBottom: 24 }}>
                {selectedEvent.name}
              </h2>
